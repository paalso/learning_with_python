'''
Exercise 3.2. A function object is a value you can assign to a variable or
pass as an argument. For example, do_twice is a function that takes
...
script.
4. Use the modified version of do_twice to call print_twice twice, argument.
...
do_twice(print, 'Hello, dude!')
do_twice(print_twice, 'spam')
print()
do_four(print, 'Hello, dude!')